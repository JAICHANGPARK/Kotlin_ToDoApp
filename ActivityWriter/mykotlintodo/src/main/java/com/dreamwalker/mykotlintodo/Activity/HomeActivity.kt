...
import com.dreamwalker.mykotlintodo.Model.ItemVO
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            ...
            if (itemVO.type == ItemVO.TYPE_HEADER) {
                ...
                if (dataItem.completed) {
                    ...
                    viewHolder.completedIconView.setImageResource(R.drawable.icon_non_check)
                }

                viewHolder.completedIconView.setOnClickListener {
                    val helper = DBHelper(this@HomeActivity)//inner 라는 예약어가 클래스에 추가되어 있어야 한다.
